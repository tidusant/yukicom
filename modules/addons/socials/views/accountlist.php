...
<div id="{{$moduleName}}" ng-controller="{{$moduleName}}">
    ...
    <div class="uk-navbar">
        <span class="uk-navbar-brand">
            ...
            <a href="@route("/$moduleName")">@lang('Social')</a> /
            <span class="uk-text-muted">Account List</span>            
        </span>
                ...
                <table class="uk-table uk-table-striped">
                    ...
                    <tbody>
                        <tr data-ng-repeat="item in items">
                            ...
                            <td>
                                <a href="@route("/$moduleName/account/")@@ item._id @@" title="@lang('Edit')">@@ item.name @@</a>
                            </td>
                            <td>@@ item.modified | fmtdate:'d M, Y' @@</td>
                            <td>@@ item.created | fmtdate:'d M, Y' @@</td>
                            <td class="uk-text-right">
                                <a href="@route("/$moduleName/account/")@@ item._id @@" title="@lang('Edit')"><i class="uk-icon-pencil"></i></a>

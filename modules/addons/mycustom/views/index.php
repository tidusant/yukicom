        ...
        <form class="uk-form" data-ng-submit="submit()" >
            <div class="app-panel">
                ...
                <div class="uk-form-row" >
                    ...
                    <div class="uk-button-group" >
                            <button type="button" ng-click="convertToMongo()" class="uk-button uk-button-primary uk-button-large">
                                <div class="app-loading uk-text-center" ng-show="convertingToMongo">
                                <i class="uk-icon-spinner uk-icon-spin"></i>
                                </div>
                                @@convertingToMongo?'':'To Mongo'@@
                            </button>                            
                        </div>
                </div>
...
<script>
    ...
    App.module.controller("{{$moduleName}}", function($scope, $rootScope, $http, $timeout) {
       ...
       //function
        ...
        $scope.convertToMongo = function() {

            if($scope.convertingToMongo)return;
            $scope.convertingToMongo=1;

            $http.post(App.route("/api/{{$moduleName}}/convertToMongo"), {}).success(function(data){
            ...
            }).error(function(data){$scope.convertingToMongo=0;App.module.callbacks.error.http();});
        };

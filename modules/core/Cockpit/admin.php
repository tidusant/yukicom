...
$app->on("cockpit.content.fields.sources", function() {
    ...
    echo $this->assets([
        ...
        'assets:js/field.linkcollection.js',//duy.ha custom: move resource out to assets folder to remove collecitons module
        'assets:js/field.pathpicker.js',//duy.ha custom: move resource out to assets folder to remove mediamanager module

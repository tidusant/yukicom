    ...
    var html = $('html'),
        ...
        App  = {
            ...
            Ui: {
                ...
                //duy.ha: show modal with UIkit
                modal: function(divId,options){                    
                    var modal=$.UIkit.modal(divId, options);
                    if ( modal.isActive() ) {
                        modal.hide();
                ...
                dialog: function(content, options) {
                    //duy.ha: fix show dialog from UIkit doc: http://getuikit.com/docs/modal.html

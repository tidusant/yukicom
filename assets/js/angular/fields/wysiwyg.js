    ...
    angular.module('cockpit.fields').directive("wysiwyg", ['$timeout', function($timeout){
        ...
        var generatedIds  = 0,
            ...
            plugins: [
                ...
                "table contextmenu paste textcolor","wordcount"
            ],
            toolbar: "forecolor backcolor,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,styleselect,formatselect,fontselect,fontsizeselect",
